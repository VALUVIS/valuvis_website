...
const services = [
  {
    ...
    path: '/Immobilien-verkaufen/Wohnung-verkaufen'
  },
  {
    number: '02',
    ...
    path: '/Immobilien-verkaufen/Haus-verkaufen'
  },
  {
    number: '03',
    ...
    path: '/Immobilien-verkaufen/Gewerbeimmobilie-verkaufen'
  },
  {
    number: '04',
    title: 'Kauf',
  ...
  },
  {
    ...
    path: '/Dienstleistungen/Marktanalyse'
  },
  {
    number: '08',
    title: 'Marketing',
    ...
    path: '/Dienstleistungen/Marketing'
  },
  {
    number: '09',
    title: 'Home Staging',
    ...
    path: '/Dienstleistungen/Home-Staging'
  }
];
    ...
    <div className='flex flex-col gap-16 m-5'>
      ...
      <section className='bg-neutral-50 grid grid-cols-1 md:grid-cols-3 p-14 gap-16 rounded-lg'>
        {services.map((service) => (
          <div key={service.number} className='flex flex-col items-start gap-3'>
            ...
            <Link href={service.path} className='text-xs md:text-s lg:text-base tracking-wider text-orange-500 pr-3 pl-3 pt-2 pb-2 rounded-lg hover:bg-orange-500 hover:text-white border border-orange-500'>Mehr erfahren</Link>
          </div>
        ))}
      </section>
    </div>
